return {
    ...
    {
        "Evil is evil. Lesser, greater, middling, makes no difference. The degree is arbitrary. The definitions blurred.",
    ...
    {
        "Finish all your business before you die. Bid loved ones farewell. Write your will. Apologize to those you’ve wronged.",
    ...
    {
        "If you're about to be hanged, ask for a glass of water. Anything can happen before they fetch it.",
    },
    {
