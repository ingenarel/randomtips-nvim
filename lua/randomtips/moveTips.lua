return {
    ...
    {
        "t{char} is used to move to the [count]'th before occurrence of {char} to the right.",
    ...
    },
    {
        ...
        "giving [range], the last number in it used as the byte count.",
    ...
    { "dl deletes character (alias: x)" },
    { "diw deletes inner word" },
    { "daw deletes a word" },
    { "diW deletes inner WORD (see |WORD|)" },
    { "daW deletes a WORD (see |WORD|)" },
    { "dgn deletes the next search pattern match" },
    { "dd deletes one line" },
